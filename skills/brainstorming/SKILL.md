...
6. **Write design doc** — save to `docs/superpowers/specs/YYYY-MM-DD-<topic>-design.md` (do NOT commit it to git)
...
- Do NOT commit the design document to git — leave it as an untracked working file
