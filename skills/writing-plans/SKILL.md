...
**Context:** Do not plan any git isolation steps (branch creation, worktrees). Your human partner manages the git layout; the plan covers the work, not the workspace.
